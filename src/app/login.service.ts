import { HttpEvent, HttpClient, HttpInterceptor, HttpHandler, HttpRequest } from '@angular/common/http';
...
export class LoginService {
  ...
  auth0 = new auth0.WebAuth({
    clientID: '69b92f28ab8141efb346491e7b483a87',
    domain: 'login.eveonline.com/oauth',
    responseType: 'code',
